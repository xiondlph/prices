...
require([
    ...
    'View/Georegion',
    'View/Loader'
], function ($, MenuView, ModelsView, GeoregionView, LoaderView) {
    ...
    params.on('change:categoryId', function () {
        Layout  = new ModelsView.Layout({obj: $('.b-section'), categoryId: params.get('categoryId') || undefined, reloadModels: function () {
