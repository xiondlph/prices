...
<# } else { #>
                ...
                <a href="#" class="b-nav__item b-nav__item_right b-nav__item_hidden j-nav__item__signup">Регистрация</a>
<# } #>
<#
                /*<div class="b-menu">
                    <ul class="b-menu__sub">
...
#>
<# if(this.data.user){#>
                <a href="/about#about" class="b-nav__flow b-nav__flow_first">О сервисе</a>
                <a href="/about#destiny" class="b-nav__flow">Преимущество</a>
                <a href="/about#description" class="b-nav__flow">Описание</a>
                <a href="/about#terms" class="b-nav__flow">Условия</a>
<# } else { #>
